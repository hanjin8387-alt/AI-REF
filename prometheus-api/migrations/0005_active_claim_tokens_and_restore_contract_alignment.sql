-- Migration 0005: active idempotency claim tokens and strict shopping restore normalization
-- Forward-only. 0001/0002/0003/0004 remain unchanged.
...
ALTER TABLE idempotency_keys
    ALTER COLUMN claim_token SET DEFAULT uuid_generate_v4();
